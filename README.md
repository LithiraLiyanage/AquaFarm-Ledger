...
**AquaFarm Ledger** is a premium, production-style **full-stack AquaTech SaaS application** built for modern fish farm management.

It helps aquaculture businesses manage **ponds, fish batches, feeding logs, water quality, mortality, harvest planning, alerts, reports, and cost analytics** from one beautiful dashboard.

> 🌊 Built with a purple, black, white and aqua-green SaaS theme to feel like a real startup product.
...
| Role                  | Access Level                                            |
| --------------------- | ------------------------------------------------------- |
| 👑 Farm Owner / Admin | Full access to all modules, reports, settings and users |
| 🧑‍💼 Farm Manager    | Manage ponds, batches, feed, harvest and reports        |
| 🧪 Technician / Staff | Add feed, water quality and mortality records           |
...
* 🐟 Active fish batches
* 🔢 Total stock count
* 🌾 Today’s feed quantity
* ☠️ Mortality rate
* 💧 Water quality score
* 💰 Estimated harvest value
* 📦 Monthly cost
* ⚠️ Recent alerts
* 📈 Water quality, feed, mortality and harvest charts

---

## 🇱🇰 Demo Data

The seed data includes realistic Sri Lankan aquaculture examples:
...
```bash
git clone https://github.com/LithiraLiyanage/AquaFarm-Ledger.git
cd AquaFarm-Ledger
```
...
| 🔐 Auth           | `/api/auth`          |
| 🏞️ Ponds         | `/api/ponds`         |
| 🐟 Fish Batches   | `/api/batches`       |
| 🌾 Feed Logs      | `/api/feed-logs`     |
| 💧 Water Quality  | `/api/water-quality` |
| ☠️ Mortality      | `/api/mortality`     |
| 🗓️ Harvest Plans | `/api/harvests`      |
| 💰 Costs          | `/api/costs`         |
| ⚠️ Alerts         | `/api/alerts`        |
| 📋 Reports        | `/api/reports`       |
...
AquaFarm Ledger includes smart aquaculture calculations:
...
```txt
60% Soft White / Light Glass
30% Deep Black / Dark Navy
10% Premium Purple
Accent: Aqua Green
```
...
* 🤖 AI-powered fish growth prediction
* 📱 Mobile app version
* 🌐 IoT sensor integration for live water data
* 📡 SMS / WhatsApp alert notifications
* 📄 PDF report export
* 🧾 Invoice and sales management
* 🗺️ Multi-farm location tracking
* 🧠 Machine learning based disease risk detection
